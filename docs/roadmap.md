...
| P2–P5、H1–H3、X1–X3 | 待实施 / 待对应条件 | 下表和任务计划定义未来交付，不代表已运行 |
...
- [ ] WP-P2-01–08：持久工作流 v1，复用 P1 的项目身份、预约、领取闸门与取消意图。

按[近期批次](operations-implementation.md)领取 P2 任务；P1 的接手物见 [P1 记录](p1-readiness.md)。每阶段更新入口、对应 readiness 和路线状态；只有实际运行才向 `eval/BASELINES.md` 追加结果。季度技术雷达继续保留。
