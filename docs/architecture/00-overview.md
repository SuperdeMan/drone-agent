...
| 使用入口 | 本机任务台只规划与签名；云端统一入口提供 M2 自然语言任务和 M1 固定巡检，实调模型经允许列表代理出站 | [任务台](../tailnet-desk.md) · [部署](07-deployment.md) |
...
2026-09-24 的证据闭环、停机修复与统一入口由 D037 记录，准确版本与新增验收见 [M2 评审记录](../m2-review-2026-09-24.md)。
