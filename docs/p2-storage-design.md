...
**状态：2026-09-26 已批准（用户批准，含常驻任务台账本的带备份迁移），已实施。** 常驻任务台账本已先完成第 6 节的副本演练再迁移，迁移前备份 `ledger-v2-20260926T043816364350Z.sqlite3` 保留在云端状态目录，见 [P2 记录](p2-readiness.md)。本文列出现有 schema、P2 新增表、事务与唯一约束、与 P1 表的连接、迁移 / 备份 / 回退和演练。
